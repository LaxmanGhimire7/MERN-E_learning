...
const {getStudentAssignments, submitAssignment, getStudentSubmissions, getAllSubmissionsForInstructor, gradeAssignment} = require("../Controller/assignmentSubmissionController");
